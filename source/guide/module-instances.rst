...
* ``variables`` --- the variables captured by the trigger as an integer-indexed Lua table. Each variable is of the type ``Variant``. `See the Scripting API documentation for information about Variants <http://www.pharoscontrols.com/software_help/designer2/Default.htm#Help/Reference/Scripting/Variants.htm>`_. See the Designer help for information about using variables in conditions.
...
* ``variables`` --- the variables captured by the trigger as an integer-indexed Lua table. Each variable is of the type ``Variant``. `See the Scripting API documentation for information about Variants <http://www.pharoscontrols.com/software_help/designer2/Default.htm#Help/Reference/Scripting/Variants.htm>`_. See the Designer help for information about using variables in actions.
...
Where ``variables`` is the array of values passed to ``module:broadcast()``, converted to the ``Variant`` type. `See the Scripting API documentation for information about Variants <http://www.pharoscontrols.com/software_help/designer2/Default.htm#Help/Reference/Scripting/Variants.htm>`_.

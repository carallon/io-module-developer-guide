# -*- coding: utf-8 -*-
#
# IO Module Developer Guide documentation build configuration file
#
...
if variant == 'mosaic':
    ...
    copyright = f'{current_year} Electronic Theatre Controls, Inc'
    author = u'Electronic Theatre Controls, Inc'
    rst_prolog = """.. |Vendor| replace:: Mosaic
.. |IO modules path in Documents| replace:: ``Documents/ETC/MosaicDesigner 2/IO Modules/``"""
    extlinks = {'api_docs': ('https://etc-mosaic-controller-api.readthedocs.io/en/latest/%s', 'api_docs ')}
else:
...
.. |IO modules path in Documents| replace:: ``Documents/Pharos Controls/Designer/IO Modules/``"""
    extlinks = {'api_docs': ('https://pharos-controller-api.readthedocs.io/en/latest/%s', 'api_docs ')}
...
latex_documents = [
    (master_doc, 'IOModuleDeveloperGuide.tex', u'IO Module Developer Guide',
     u'Pharos Architectural Controls Ltd', 'manual'),
]
